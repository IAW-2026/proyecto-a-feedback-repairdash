...
export default function EstadoBadge({ estado }: EstadoBadgeProps) {
  if (estado === 'SinResolver') {
    return (
      <span className="bg-brand-accent-soft/20 text-brand-text-light text-xs font-medium px-[clamp(0.75rem,2vw,1rem)] py-[clamp(0.375rem,1vw,0.5rem)] rounded-full inline-flex items-center gap-1.5 whitespace-nowrap min-h-[28px]">
